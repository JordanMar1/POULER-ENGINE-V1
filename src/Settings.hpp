...
public:
    ...
    // FIX: compensation FOV — à utiliser dans le code de rotation caméra
    // à la place de horizontal_sensitivity / vertical_sensitivity directement
    float getFovCompensation() const;
    float getEffectiveHSens()  const;
    float getEffectiveVSens()  const;
